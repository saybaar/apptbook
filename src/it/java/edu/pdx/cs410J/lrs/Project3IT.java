...
public class Project3IT extends InvokeMainTestCase {
    ...
    public void testExpectedCommandLineArguments() {
        MainMethodResult result = invokeMain("-print", "Caesar", "conquering", "01/02/3456", "12:34", "AM", "9/8/7654", "3:21", "PM");
    ...
    public void testWithoutPrint() {
        MainMethodResult result = invokeMain("Caesar", "conquering", "01/02/3456", "12:34", "am", "9/8/7654", "3:21", "pm");
        assertThat(result.getExitCode(), equalTo(0));
    ...
    public void testTooFewCommandLineArguments() {
        MainMethodResult result = invokeMain("Caesar", "conquering", "12:34", "am", "9/8/7654", "3:21", "pm");
        assertThat(result.getExitCode(), equalTo(1));
        assertThat(result.getErr(), containsString("Wrong number of options"));
    }
    ...
    public void testBadDateFormat() {
        MainMethodResult result = invokeMain("Caesar", "conquering", "1/2/3456", "12:34", "am", "9/80/7654", "3:21", "pm");
        assertThat(result.getExitCode(), equalTo(1));
